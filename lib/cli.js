...
const { guardDisable, guardEnable, guardGlobalEnable, guardGlobalStatus, guardPlan, guardStatus } = require('./guard');
...
Usage:
  ...
  execfence guard status|enable|disable|plan|global-status|global-enable [--apply]
...
function guardCommand(args) {
  ...
  throw new Error('Usage: execfence guard status|enable|disable|plan|global-status|global-enable [--apply]');
}
